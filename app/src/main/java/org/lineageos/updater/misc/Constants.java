...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.redbird.build.version";
    public static final String PROP_DEVICE = "ro.redbird.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.redbird.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "redbirdrom.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "redbird.updater.uri";
